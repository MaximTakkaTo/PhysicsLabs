...
namespace PhysicsLabs.Labs.ten.tenOne
{
    public partial class tenOne : Window
    {
        ...
        private void reference()
        {
            ...
            progr = "\nХОД РАБОТЫ:\n1. Привести груз во вращение по нарисованной окружности радиуса R.Измерить радиус с точностью 1 см. Измерить время t, за которое тело совершит N оборотов.\n2. Определить высоту конического маятника h по вертикали от центра шарика до точки подвеса.\n3. Оттянуть горизонтально расположенным динамометром шарик на расстояние, равное радиусу окружности и измерить модуль составляющей F1 , массу шарика.\n";
